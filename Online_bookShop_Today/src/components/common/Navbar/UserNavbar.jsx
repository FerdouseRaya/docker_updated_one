...
import { faUser, faShoppingCart,faShoppingBag ,faUserPen} from "@fortawesome/free-solid-svg-icons";
      ...
      <nav>
        ...
        <div>
          <ul id="navbar">
            ...
            <Link to="/search-results">Books</Link>
            <Link to="/update-info-user" className="fa_User">
            {showReviewEdit && <UpdateUsers/>}
              <FontAwesomeIcon icon={faUserPen} />
            </Link> 
            <Link to="/login-signUp" onclick={handleEditClick} className="fa_User">
